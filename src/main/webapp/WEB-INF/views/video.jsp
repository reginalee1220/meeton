        ...
        <section class="video_contents"><!-- video_contents -->
            <form>
                ...
                <div class="video_play_info"><!-- video_play_info -->
                        ...
                        <div class="info_ppt"><!--  채널정보, 영상 제목 -->
                            <div class="channel_profile"><!-- channel_profile -->
                                <a href="channelnum.do?channelnum=${channel.channelnum}">
                                    <span><img src="/imgUpload/${user.profile}" /></span>
                                </a>
                            </div><!-- // channel_profile -->
                            <div class="aka_videoName"><!-- aka_videoName -->
                                <ul class="an">
                                    <a href="#">
                                        <li class="aka">${video.userid}</li>
                                    </a>
                                    <a href="#">
                    ...
                    <div class="video_result"><!-- 좋아요수, 댓글수, 재생수, 업로드 날짜 -->
                        <ul>
                            <li class="up">
                ...
                <div class="video_comment"><!-- video_comment -->
                    <div class="cm_input"><!-- cm_input -->
                        <div class="cm_squ"><!-- comment_squ -->
                            <span>댓글</span>
                            <span class="comq">${video.comments}</span>
                        </div><!-- // comment_squ -->
                            ...
                            <div class="cm_fm"><!-- 댓글 입력 & 등록버튼 -->
                                <form name="frm" id="frm"><!-- name id 유지 -->
                                    <div class="cm_fm_in">
                                        ...
                                        <textarea rows="3" cols="50" name="content" id="content" class="cm_cont" placeholder="댓글 입력..." ></textarea>
                                    </div>
                                    <div class="cmt_btn">
                                        <button class="frm_submit" type="submit" value="확인" id="repInsert">등록</button>
                                    </div>
                                </form>
                            </div><!-- // 댓글 입력 & 등록버튼 -->
                        </div><!-- // cm_form -->
