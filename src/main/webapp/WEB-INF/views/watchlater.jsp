            ...
            <div class="btn_video_nav" id="video_nav"><!-- btn_video_nav -->
                <ul class="tablist">
                    <li class="history" id="on_likedvideo">
                        <a href="/history.do">최근에 본 영상</a>
                    </li>
                    <li class="watchlater">
                        <a href="/watchlater.do">나중에 볼 영상</a> <!-- 현재 페이지 -->
                    </li>
                    <li class="likedvideo" >
                        <a href="/likedvideo.do">좋아요 한 영상</a>
                    </li>
                </ul>
            </div><!-- // btn_video_nav -->
                                    ...
                                    <div class="main_video_img"><!-- main_video_img -->
                                        <div class="video_play_view"><!-- video_play_view -->
                                            <div class="video_play">
                                                ...
                                                <video class="background_video" poster="/videoUpload/${w.thumbnail}" preload="metadata" muted="muted" volume="0" controls><!-- controls : 동영상 체크  -->
