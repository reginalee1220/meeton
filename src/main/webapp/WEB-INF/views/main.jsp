                ...
                <c:forEach var="v" items="${videoList}" begin="0" end="2" step="1">
                    <div class="main-video-box-ver1">
                        ...
                        <div class="main-video-viewlike-ver1">
                            <span><img src="./images/main/views.png" />${v.views}</span><!--조회수-->
                            <span><img src="./images/main/heart-solid.png" />${v.likes}</span><!--좋아요수-->
                        </div>
                ...
                <div class="main-video-box-ver2">
                    ...
                    <div class="main-video-desc-ver2">
                        ...
                        <div class="main-video-viewlike-ver2">
                            <span><img src="./images/main/views.png" />${v.views}</span>
                            <span><img src="./images/main/heart-solid.png" />${v.likes}</span>
                        </div>
                    </div>
