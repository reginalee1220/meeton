...
<head>
    ...
    <title>비번찾기</title>
    <!-- css -->
    <link rel="stylesheet" type="text/css" href="./css/pwFind/admin.css" />
    <link rel="stylesheet" type="text/css" href="./css/pwFind/member.css" />
    ...
    <c:if test="${empty pwdok}">
        ...
        <form method="post" action="pwd_find_ok.do"
            ...
            <table id="pwd_t">
                <tr>
                    <th>아이디</th>
                    <td><input name="userid" id="userid" size="14" class="input_box" /></td>
                </tr>
